...
//		"        rf my id  - Sets the ID of the node ( TX ID )\r\n"
//		"        rf end id - Sets the destination ID ( RX ID )\r\n"
//		"        rf tx     - Transmits a packet of RF\r\n"
...
//
//STATIC const u8_t SERIAL_closing_message_s[] =
//		"\r\nThe serial port has been closed due to inactivity,\r\nPlease press the \"Enter\" key to reopen the serial prompt\r\n\r\n";
//
//
//
...
//{
//	/* Finally send the welcome message */
//	SERIAL_Send_data( SERIAL_closing_message_s );
//
//	/* Disable the USART2 Receive interrupt: this interrupt is generated when the
//		USART2 receive data register is not empty */
...
//				RFM69_wakeup_and_send();
//			}
//			else if (( strstr(sub_string, "my id") != 0 ) )
//			{
//				sub_string = strstr(SERIAL_rx_buf_s, "rf") + 9;
//
//				val = atoi(sub_string);
...
//				if( val > U8_T_MAX )
//				{
//					sprintf( SERIAL_tx_buf_s, "\r\nRF node id must be between 0 and 255..\r\nPlease try again\r\n", val );
//										SERIAL_Send_data( SERIAL_tx_buf_s );
//				}
//				else
//				{
//					NVM_info_s.NVM_generic_data_blk_s.own_node_id = val;
//					NVM_request_flush();
//
//					sprintf( SERIAL_tx_buf_s, "\r\nRF node id set to %d decimal \r\n", val );
//					SERIAL_Send_data( SERIAL_tx_buf_s );
//				}
//			}
...
//				}
//			}
//			else if( ( strstr(sub_string, "end id") != 0 ) )
//			{
//				sub_string = strstr(SERIAL_rx_buf_s, "rf") + 10;
//
//				val = atoi(sub_string);
//
//				if( val > U8_T_MAX )
//				{
//					sprintf( SERIAL_tx_buf_s, "\r\nEnd node id must be between 0 and 255..\r\nPlease try again\r\n" );
//					SERIAL_Send_data( SERIAL_tx_buf_s );
//				}
//				else
//				{
//					NVM_info_s.NVM_generic_data_blk_s.end_node_id = val;
//					NVM_request_flush();
//
//					sprintf( SERIAL_tx_buf_s, "\r\nEnd node  id set to %d \r\n", val );
//					SERIAL_Send_data( SERIAL_tx_buf_s );
//				}
//			}
//			else
...
//
//			/* 2nd chunk */
//			sprintf( SERIAL_tx_buf_s, "RF own node id:\t0x%02X\r\nRF end node id:\t0x%02X\r\nRF conf:\t%d",
//					NVM_info_s.NVM_generic_data_blk_s.own_node_id,
//					NVM_info_s.NVM_generic_data_blk_s.end_node_id,
